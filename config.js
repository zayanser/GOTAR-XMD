...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "GOTAR~XMD~TlpHwDAa#pGRmWo1qQF3_5bPXB1AWqjTnAdJ1ElbLQRuCQRinaXc",
// add your Session Id 
...
MENU_IMAGE_URL: process.env.MENU_IMAGE_URL || "https://files.catbox.moe/dy7eyh.png",
// add custom menu and mention reply image url
PREFIX: process.env.PREFIX || ".",
// add your prifix for bot   
BOT_NAME: process.env.BOT_NAME || "ºƵaͥyaͣnͫº",
// add bot namw here for menu
STICKER_NAME: process.env.STICKER_NAME || "ºƵaͥyaͣnͫº",
