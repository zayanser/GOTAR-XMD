...
async (conn, mek, m, { from, prefix, quoted, q, reply }) => {
    try {
        ...
        // Validate input
        if (!q) {
            return await reply("Example : .Pair 923291350281‬");
        }

        // Fetch pairing code
        //const fetch = require("node-fetch");
        const response = await fetch(`https://stark-ali-pair.onrender.com/code?number=${q}`);
        ...
        const doneMessage = "> *GOTAR-XMD PAIR COMPLETED*";
